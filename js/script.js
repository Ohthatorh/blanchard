$(function() {
	...
	$('.catalog__accordion-list-item-link').click(function() {
		$('.catalog__accordion-list-item-link').removeClass('catalog__accordion-list-item-link-active');
		$(this).addClass('catalog__accordion-list-item-link-active');
